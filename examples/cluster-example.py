...
emulator.add_place('state', zone=MAPE.K)
...
#emulator.add_output_arc(getRequests, 'requestsB', Expression("MultiSet([(e, n)])"))
...
emulator.add_output_arc('fire', 'state', Variable('w'))
emulator.add_input_arc('state', 'getReady', Variable('w'))
emulator.add_output_arc('getReady', 'firable', Variable('w'))
