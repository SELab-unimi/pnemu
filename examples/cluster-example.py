...
emulator.add_input_arc('requestsB', 'getData', Variable('e'))
emulator.add_output_arc('getData', 'dataReady', Variable('e'))
...
emulator.add_transition('testInc1', Expression("len(r)+len(f)>=2 and i>=2"))
